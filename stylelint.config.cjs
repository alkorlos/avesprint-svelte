module.exports = {
	...
	rules: {
		...
		'selector-pseudo-class-no-unknown': [true, { // Запретить неизвестные псевдоклассы
			'ignorePseudoClasses': [ // Игнорировать псевдоклассы
				'global'
			]
		}],
		...
		"declaration-no-important": true, // Запретить !important в пределах деклараций

		'function-disallowed-list': ['rgba', 'hsl', 'hsla'], // Указать список запрещенных функций
